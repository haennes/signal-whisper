  ...
  outputs = { nixpkgs, self, ... }:
    let
      ...
      eachSystem = f:
        ...
        (system: f nixpkgs.legacyPackages.${system} nixpkgs.lib);
      models = [
        ...
        [
          "small.en-q5_1"
          "sha256-v9/0iU3Ldrv2R9ViY+oqlmRUI/FmkXb0hEob+OR4rTA="
        ]
    ...
    in rec {
      packages = eachSystem (pkgs: lib:
        ...
        in recursiveMerge (lib.lists.map (model:
          let
